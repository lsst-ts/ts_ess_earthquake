...
void ms_loginit_main(MSLogParam *logp, void (*log_print)(const char *), const char *logprefix,
 ...
 ***************************************************************************/
void ms_loginit(void (*log_print)(const char *), const char *logprefix, void (*diag_print)(const char *),
 ...
 ***************************************************************************/
MSLogParam *ms_loginit_l(MSLogParam *logp, void (*log_print)(const char *), const char *logprefix,
                         void (*diag_print)(const char *), const char *errprefix) {
    MSLogParam *llog;
...
void ms_loginit_main(MSLogParam *logp, void (*log_print)(const char *), const char *logprefix,
    ...
    if (log_print) logp->log_print = log_print;
    ...
    if (diag_print) logp->diag_print = diag_print;
